...
const Movie: React.FC<MovieProps> = ({ onClick, movie }) => {
  ...
  return (
    <div
      className="overflow-hidden text-white transition-transform transform border border-transparent rounded shadow-lg opacity-75 cursor-pointer hover:border-white hover:opacity-100 animate-fadeIn group"
      onClick={onClick}
      role="button"
      tabIndex={0}
      onKeyDown={(e) => {
